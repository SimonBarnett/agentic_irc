...
cl /nologo /O2 /W3 /DWIN32 /DWINVER=0x0501 /D_WIN32_WINNT=0x0501 /D_CRT_SECURE_NO_WARNINGS ^
  main.c util.c aes256gcm.c config.c jail.c moot.c dumb_job.c irc_tls.c pair.c ^
  /Fe:airc-moot-thin.exe /link ws2_32.lib secur32.lib crypt32.lib advapi32.lib
